...
الوحدات
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">جدول</a></li>
            <li class="active">بيانات   الوحدة</li>
          </ol>
        </section>
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="">اضاف   وحدة    </button>
...
<a href="unit/{{$user->id}}" type="button" class="btn btn-danger">حذف</a>
  </div>
</td>
                      </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="UniEdit/{{$user->id}}" method="post">
          @csrf
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">اسم المنتج:</label>
            <input type="text" class="form-control" id="recipient-name" name="proname" value="{{$user->unitname}}" required>
            <span style="color: red;"> </span>
          </div>
 </div>
