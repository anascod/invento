        ...
        <div class="content-wrapper">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="#">جدول</a></li>
              <li class="active">بيانات الموردين</li>
            </ol>
          </section>
            ...
            <div class="row">
              ...
              <div class="box">
                <div class="box-header">
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="">اضاف  المنتجات </button>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="InsertSupp" method="post">
                           @csrf
              ...
              <div class="box-body" style="text-align: center;">
                <table id="example" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    @foreach ($suppll as $user)

                    <tr>
                      <td>{{ $user->supplu_name}}</td>
                      <td>{{ $user->supplu_email}}</td>
                      <td>{{ $user->supplu_addr }}</td>
                      <td> {{ $user->supplu_phone }}</td>
                      <td>
                       ...
                       <div class="btn-group mr-2 " role="group" aria-label="Second group">
                        ...
                        <a href="supply/{{$user->id}}" type="button" class="btn btn-danger">حذف</a>
                  ...
                  <div class="modal fade" id="exampleModa{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="SuppEdit/{{$user->id}}" method="post">
                            @csrf
                            <input type="hidden" name="idsup" value="{{$user->id}}">
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">اسم المورد:</label>
                              <input type="text" class="form-control" id="recipient-name" name="supplu_nameedit" value="{{$user->supplu_name}}" required>
                              <span style="color: red;"> </span>
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">العنوان:</label>
                              <input type="text" class="form-control" required id="recipient-name" name="supplu_addredit" value="{{$user->supplu_addr}}">

                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">البريد الاكتروني:</label>
                              <input type="text" class="form-control" id="recipient-name" name="supplu_emailedit" value="{{$user->supplu_email}}" required>
                            </div>
                            <div class="form-group">
                              <label for="recipient-name" class="col-form-label">رقم الهاتف:</label>
                              <input type="text" class="form-control" id="recipient-name" name="supplu_phoneedit" value="{{$user->supplu_phone}}" required>
              ...
              <div class="box-body" style="text-align: center;">
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{ $showda->supplyname}}</td>
                      <td>{{ $showda->totalamount}}</td>
                      <td>{{ $showda->remaining }}</td>
    ...
    <div class="modal fade" id="exampleModal{{$showda->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="Paysup/{{$showda->id}}" method="post">

              @csrf
              <input type="hidden" name="idsup" value="{{$showda->id}}">
              <input type="hidden" name="supplyname" value="{{$showda->supplyname}}">
              <div class="form-group">
                <label for="recipient-name" class="col-form-label">اجمالي المبلغ</label>
                <input type="text" class="form-control" id="recipient-name" name="totamoun" value="{{$showda->remaining}}" disabled>
                <span style="color: red;"> </span>
              </div>
              <div class="form-group">
            ...
            <div class="modal-body">
             <table id="modaldata" class="table table-striped table-hover table-bordered">
              <thead>
                ...
                @if($isol->pay_supply_id==$showda->payid)
                <tr>
                  <td>{{ $loop->iteration}}</td>
                  <td>{{ $isol->amount }}</td>
                  <td>{{ $isol->payment }}</td>
                  <td> {{ $isol->remain }}</td>
                  <td> {{ $isol->created_at}}</td>
