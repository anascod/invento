...
.center {
  ...
  <body dir="rtl" onload="print()">
    ...
    <article>
      ...
      <table class="meta">
        <tr>
          <th><span > الفاتورة م#</span></th>
          <td><span >{{$invo}}</span></td>
        </tr>
        <tr>
      ...
      <tr>
          <th><span > العميل#</span></th>
          <td><span >{{$custnam}}</span></td>
        </tr>
      </table>
...
@endforeach    
      ...
      <table class="balance">
        <tr>
          ...
          <td><span data-prefix>SDG</span><span>  {{array_sum($totalValues)}}</span></td>
        </tr>
        @if (!empty($cuspay)) 

        <tr>
          <th><span contenteditable>الدفعة الاولة</span></th>
    <td><span data-prefix>SDG</span><span> {{ $cuspay }}</span></td>

        </tr>

        <tr>
          <th><span contenteditable>الصافي</span></th>
    <td><span data-prefix>SDG</span><span> {{ array_sum($totalValues)-$cuspay }}</span></td>
